  ...
  <main style="font-family: 'Oxygen', sans-serif;">
        <div class="container bg-white">
            <div class="row">
                ...
                border-radius: 40px 10px; margin-top:4%">      
                    <h1 class="text-white text-center mt-3 ml-5 mr-5 face">¿Que nos hace Unicos?</h1></div>
                    <div class="col-6 mt-5 text-secondary">
                        <p class="text-info" style="margin-left:2%;">En Clínica Coral nos sentimos honrados de que hayas elegido nuestros consultorios para el cuidado de lo más preciado, tu sonrisa.</p>
                        <p class="text-info" style="margin-left:2%;">Es por eso que nos esforzamos por mantenernos siempre actualizados, utilizando la mejor tecnología y las técnicas más vanguardistas como el Sistema Damon y Ortodoncia Personalizada (Insignia), entre muchos otros beneficios que ponemos a tu alcance para un tratamiento más eficiente y con mejores resultados.</p>
                    </div>
    
                    <div class="col-6 mt-5 rounded">
                        <img class="rounded w-70 img-responsive" style="margin-left:2%; border-radius: 2em; border: none;
                        border-radius: 40px 10px;"
                            src="https://clinicabalut.com/wp-content/uploads/2019/04/que_nos_hace_unicos_1.jpg" alt="promocion">
                    </div>
    
    
                    <div class="col-6  text-secondary">
    
                        <p class="text-info" style="margin-left:2%;">
                                Tu salud es lo más importante para nosotros, por lo que mantenemos un alto control de infecciones en todos nuestros procedimientos, además de contar con instalaciones diseñadas para que tu experiencia ortodóncica sea cómoda y agradable.</p>
                        ...
                        <p class="text-info" style="margin-left:2%;">Sabemos que tu día a día está lleno de actividades, por lo que nuestro personal estará pendiente de hacerte llamadas telefónicas o enviarte correos electrónicos para evitar que olvides tus citas.</p>
    
                        <p class="text-info" style="margin-left:2%;">En Clínica Coral hacemos que tus citas sean eficientes y agradables.</p>
                    ...
                    <div class="col-6 mt-5 rounded">
                        <img class="rounded w-70 img-responsive" style=" margin-left:2%; border-radius: 2em; border: none;
                        border-radius: 40px 10px;" src="https://clinicabalut.com/wp-content/uploads/2019/04/que_nos_hace_unicos_2.jpg"
                            alt="promocion">
                    </div>
