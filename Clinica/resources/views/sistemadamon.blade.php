        ...
        <div class="container bg-white">
            <div class="row">
                ...
                border-radius: 40px 10px;">      
                    <h1 class="text-white text-center mt-3 ml-5 mr-5">Sistema Damon</h1>
                </div>
                <div class="col-6 mt-5 text-secondary ">
                  <div class="card text-left">
                    <div class="card-body">
                      <p class="card-text text-align-center" style="margin:2%;">Ventajas probadas clínicamente
                        Hasta 7 meses de reducción del tiempo de tratamiento.
                        Reducción significativa del número de citas.
                        Importante mejora del confort del paciente.
                        Mejora significativa de la calidad de los resultados.</p>
                        <p class="card-text text-align-center" style="margin:2%;">El Sistema Damon es la mejor combinación de brackets de autoligado pasivo con arcos de
                          fuerza calibrada y protocolos de tratamiento mínimamente invasivos, que se combinan para
                          crear un sistema de baja fricción. <br><br>
                          Los brackets de autoligado pasivo Damon ayudan a mejorar la posición de los dientes de forma
                          más biológica, permitiendo libertad de movimiento con el uso de fuerzas suaves, mientras que
                          las ligaduras convencionales causan fricción y molestias, además de requerir más fuerza y
                          ajustes frecuentes.</p>
                    </div>
                  </div>
                </div>
                <div class="col-12-md mt-5 rounded" style="margin-bottom:2%; margin-left:8%;">
                    <img class="rounded w-50 img-responsive"
                        src="assets/img/56161376_340798199878859_8579532859813920768_n.jpg" alt="promocion" style="border-radius: 2em; border: none;
                        border-radius: 40px 10px;">
                </div>
            </div>
        </div>
