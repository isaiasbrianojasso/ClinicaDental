        ...
        <div class="container bg-white">
            <div class="row">
                ...
                border-radius: 40px 10px; margin-top:2%">      
                    <h1 class="text-white text-center mt-3 ml-5 mr-5 face">Alimentos que hay que
                        evitar</h1></div>
                    <div class="col-6 mt-5 text-secondary">
                        <div class="col-12 bg-warning" style="border-radius: 2em; border: none;
                        border-radius: 40px 10px; margin-top:2%">      
                        <h2 class="text-primary text-center">Alimentos que hay que evitar al usar brackets</h2></div>
                        <p class="text-info" style="margin-left:2%;">Hay que evitar al usar brackets ciertos alimentos para que tu tratamiento no se
                            vea afectado. Para la mayoría de las situaciones el sentido común te dirá qué evitar, sin
                            embargo, no está de más recordarte que alimentos son dañinos para tu tratamiento.</p>
                        <ul class="text-info">
    
                            <li>Los alimentos duros pueden romper o dañar los brackets y alambres, será mejor evitarlos.
                            </li>
                            <li>Los alimentos pegajosos pueden meterse entre los brackets y alambres provocando molestias.
                            </li>
                            <li>También debes reducir al mínimo los alimentos azucarados; recuerda que causan caries y
                                problemas relacionados.</li>
    
                            <li>Morderse las uñas, masticar el lápiz, pluma u otros objetos debe ser evitado.</li>
                        </ul>
                    ...
                    <div class="col-6 mt-5 rounded">
                        ...
                        style="margin-bottom:2%; margin-left:8%;  border-radius: 40px 10px;"
                            ...
                            src="https://clinicabalut.com/wp-content/uploads/2019/04/alimentos_evitar_1.jpg"
                            alt="promocion">
                    </div>
    
    
                    <div class="col-6  text-secondary">
                        <h4 class="text-primary text-center" style="margin-left:2%;"> Ejemplos</h4>
                        <p class="text-primary" style="margin-left:2%;">Ejemplos de comida pegajosa que hay que evitar:</p>
                        <ul class="text-info">
                            <li>Chicle</li>
                            <li>Chiclosos</li>
                            <li>Caramelos</li>
                        ...
                        <p class="text-primary" style="margin-left:2%;">Ejemplos de comida dura que hay que evitar:</p>
                        <ul class="text-info">
                            <li>Hielo</li>
                            <li>Nueces</li>
                            <li>Pan duro</li>
                            <li>Elote</li>
                            <li>Manzanas enteras</li>
                            <li>Zanahorias crudas enteras</li>
                            <li>Palomitas</li>
                            <li>Muéganos</li>
                            <li>Morder dulces</li>
                        </ul>
                        ...
                        <p class="text-primary" style="margin-left:2%;">Minimizar el consumo de azúcares como:</p>
                        <ul class="text-info">
                            <li>Pasteles</li>
                            <li>Helados</li>
                            <li>Galletas</li>
                        ...
                        <p class="text-primary" style="margin-left:2%;">Solamente una vez al día:</p>
                        <ul class="text-info">
                            <li>Refrescos</li>
                    ...
                    <div class="col-6 mt-5 rounded">
                        ...
                        style="margin-bottom:2%; margin-left:8%; margin-bottom:20%; border-radius: 40px 10px;"
                            ...
                            src="https://clinicabalut.com/wp-content/uploads/2019/04/que_nos_hace_unicos_2.jpg"
                            alt="promocion">
                    </div>
