        ...
        <div class="container bg-white">
            <div class="row">
                ...
                border-radius: 40px 10px; margin-top:2%">      
                    <h1 class="text-white text-center  mt-3 ml-5 mr-5 face">Preguntas Frecuentes</h1></div>
                    <div class="col-6 mt-5 text-secondary">
                        <div class="col-6 mt-5 text-secondary">
                            <h2 class="text-primary  face text-center">¿Qué brackets utilizan en los tratamientos de ortodoncia?
                            </h2>
                            <p class="text-info face" style="margin:2%;">Los tratamientos de ortodoncia de Clínica Balut utilizan brackets Ormco que van de acuerdo al tratamiento más adecuado para ti, siguiendo claro, el Sistema Damon. Los brackets de autoligado pasivo Damon ayudan a mejorar la posición de tus dientes de forma biológica, permitiendo libertad de movimiento con el uso de fuerzas suaves. De este modo la fricción y molestias disminuyen enormemente en comparación con el sistema convencional, además de obtener resultados satisfactorios en menos tiempo.</p>
                            
                          
                            <h2 class="text-primary face text-center">¿Hay brackets estéticos?</h2>
                            <p class="text-info" style="margin:2%;">Por supuesto que sí. De acuerdo al diagnóstico que te realice el Dr. Balut, podremos elegir cuál de nuestros tratamientos de Ortodoncia Invisible es el más adecuado para ti.</p>
        
                            <h2 class="text-primary face text-center">Se me acaba de caer un bracket ¿puedo ir hasta mi siguiente cita de revisión?
                            </h2>
                            <p class="text-info face" style="margin:2%;">Es muy importante que si se te cayó un bracket o lo sientes flojo, llames a nuestros consultorios para agendar una cita lo antes posible. De otro modo, tu tratamiento podrá ser más tardado.Guarda tu bracket en un lugar seguro y llévalo contigo el día de la cita, de este modo, evitarás cargos extras.</p>
        
                            <h2 class="text-primary face text-center">Después de mi última cita me duelen mucho los dientes ¿qué puedo hacer?
                            </h2>
                            <p class="text-info face" style="margin:2%;">Es muy normal que sientas dolor en los dientes después de tu último ajuste en tu tratamiento de ortodoncia. Para aliviar las molestias puedes tomar algún analgésico para el dolor, siempre y cuando no contenga ácido acetilsalicílico. Te recomendamos tomar un Motrin 600 mgs o Tylenol, si no el que tengas en casa.</p>
                        </div>
        
                        <div class="col-6 mt-5 rounded">
                            <img class="rounded w-70 face img-responsive" 
                            style="margin-bottom:2%; margin-left:8%; margin-bottom:20%; border-radius: 40px 10px;"

                            src="https://clinicabalut.com/wp-content/uploads/2019/04/banner_CB.jpg"
                                alt="promocion">
                        </div>
