        ...
        <div class="container bg-white">
            <div class="row">
                ...
                border-radius: 40px 10px;">      
                    <h1 class="text-white text-center mt-3 ml-5 mr-5">Ortodoncia a Edades Tempranas</h1>
                </div>
                <div class="col-6 mt-5 text-secondary ">
                  <div class="card text-left">
                    <div class="card-body">
                        <div class="col-6 mt-5 text-secondary">
                            <div class="col-6 mt-5 text-secondary">
                                <p class="text-info text-align-center">
                                    <ol class="text-info">
                                        <li>
                                            A esta edad podemos detectar problemas menores en los maxilares y los dientes
                                            permanentes que empiezan a salir, cuando los dientes de leche están todavía presentes.
                                        </li>
                                        <li>
                                            A pesar de que los dientes de tu hijo(a) parezcan estar derechos, puede haber problemas
                                            que el ortodoncista detectará, es por eso que debes dar importancia a la ortodoncia para
                                            niños.
                                        </li>
            
                                        <li>
                                            La evaluación puede revelar que la mordida de tu hijo(a) se encuentra en buen estado o
                                            identificar si existe algún problema que necesite ser monitoreado durante el crecimiento
                                            y desarrollo del menor.
                                        </li>
                                        <li>
                                            Comenzar el tratamiento temprano puede prevenir e interceptar problemas antes de que
                                            estos se conviertan en algo más serio, también pueden acortar el tiempo de tratamiento y
                                            minimizar complicaciones en el futuro.
                                        </li>
                                    </ol>
                                </p>
                            ...
                            <div class="col-6 mt-5 rounded">
                                <img class="rounded w-70 img-responsive" style="margin-bottom:2%; margin-left:8%;  border-radius: 40px 10px;"
                                    src="https://clinicabalut.com/wp-content/uploads/2019/04/ortodoncia_edades_tempranas_1.jpg"
                                    alt="promocion">
                            </div>
            
            
                            <div class="col-6 mt-5 text-secondary">
                                <p style="font-family: 'Oxygen', sans-serif;" class="text-secondary text-align-center">
                                    <ol class="text-info ">
                                        
                                        <p style="font-family: 'Oxygen', sans-serif; ">El tratamiento temprano nos permite:</p>
                                        <li>
                                            Guiar el crecimiento de los maxilares
            
                                        </li>
                                        <li>
                                            Reducir el riesgo de trauma a los dientes anteriores
                                        </li>
                                        ...
                                        <li>
                                            Acomodar los dientes, labios y rostro a una mejor posición
                                        </li>
                                    </ol>
                                    <p class="text-primary" style="margin-left:2%;">El paciente tendrá una mejor oportunidad de tener una bella y sana
                                        sonrisa al recibir una evaluación temprana.</p>
                                    <p class="text-warning" style="margin-left:2%;">Si tu hijo(a) es mayor de 7 años, no es tarde para una evaluación de
                                        ortodoncia.
                            ...
                            <div class="col-12 mt-5 rounded">
                                <img class="rounded w-40 img-responsive"   style="margin-bottom:2%; margin-left:8%;  border-radius: 40px 10px;"
                                    src="https://clinicabalut.com/wp-content/uploads/2019/04/ortodoncia_edades_tempranas_2.jpg"
                                    alt="promocion">
                            </div>
            
            
                            <div class="col-12 mt-5 ml-auto mr-auto rounded">
                                <img class="rounded img-responsive" width="80%"  style="margin-bottom:2%; margin-left:8%;  border-radius: 40px 10px;"
                                    src="https://clinicabalut.com/wp-content/uploads/2019/04/ortodoncia_edades_tempranas_3.jpg"
                                    alt="">
            
                            </div>
            
                            <div class="col-12 mt-2 ml-auto mr-auto rounded">
                                <img class="rounded img-responsive" width="80%"  style="margin-bottom:2%; margin-left:8%;  border-radius: 40px 10px;"
                                    src="https://clinicabalut.com/wp-content/uploads/2019/04/ortodoncia_edades_tempranas_4.jpg"
                                    alt="">
            
                            </div>
                            <div class="col-12 mt-2 ml-auto mr-auto ">
                                <img class="rounded img-responsive" width="80%"   style="margin-bottom:2%; margin-left:8%;  border-radius: 40px 10px;" src="https://clinicabalut.com/wp-content/uploads/2019/04/ortodoncia_edades_tempranas_5.jpg
                                        " alt="">
