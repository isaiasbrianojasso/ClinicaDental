        ...
        <div class="container bg-white">
            <div class="row">
                ...
                border-radius: 40px 10px; margin-top:4%">      
                    <h1 class="text-white text-center mt-3 ml-5 mr-5 face">Promociones</h1></div>
                    <div class="col-6 mt-5 text-secondary">
                        <div class="col-12 bg-warning">      
                       <div class="col-6 mt-5 text-primary">
                        <p class="text-info text-left" style="margin-left:2%;">❗❗APROVECHA LA PROMOCIÓN POR TIEMPO LIMITADO.❗❗</p>
    
                        <p class="text-info text-left"  style="margin-left:2%;" > ✅ 30% En tratamiento de ortodoncia
                            Es un tratamiento de Calidad.</p>
    
                            <p class="text-info text-left"  style="margin-left:2%;"> ✅Incluyen Fotografías clínicas, modelos de estudio y
                                diagnóstico.</p>
    
                                <p class="text-info text-left"  style="margin-left:2%;"> 👩🏻‍⚕👨🏻‍⚕ El tratamiento de Ortodoncia mejora la estética
                                    y la oclusión, se obtienen excelentes resultados con nuestros ESPECIALISTAS Acreditados
                                    por AMO.</p>
    
                                    <p class="text-info text-left"  style="margin-left:2%;"> TRATAMIENTOS DE VANGUARDIA, CON MATERIALES DE CALIDAD Y
                                        RESULTADOS EFECTIVOS.</p>
    
                                        <p class="text-info text-left"  style="margin-left:2%;"> 💳Aceptamos tarjetas de débito y crédito.</p>
                                            <p class="text-info text-left"  style="margin-left:2%;"> 📍Horario de 10-2 y de 4-8 pm. En Av. Coral
                                                #1021 col Valle Dorado, a dos cuadras del estadio Alfonso Lastras. En SLP.</p>
                    </div>
                    <div class="col-6 mt-5 rounded">
                        <img class="rounded w-70 img-responsive"
                        style="margin-left:2%; border-radius: 2em; border: none; border-radius: 40px 10px; margin-top:2%;"

                            src="/assets/img/img/promocion1.jpeg"
                            alt="promocion">
                    </div>
                    ...
                    <div class="col-6 mt-5 rounded">
                        <img class="rounded w-70 img-responsive"
                        style="margin-left:2%; margin-bottom:12%; border-radius: 2em; border: none; border-radius: 40px 10px; margin-top:2%"

                            src="/assets/img/img/promocion2.jpeg"
                            alt="promocion">
                    </div>
