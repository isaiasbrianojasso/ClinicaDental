        ...
        <div class="container bg-white">
            <div class="row">
                ...
                border-radius: 40px 10px; margin-top:2%">      
                    <h1 class="text-white text-center mt-3 ml-5 mr-5 face">Mini Implantes para Ortodoncia</h1>
                </div>
   
                <div class="col-6 mt-5 text-primary">
                    <h4 style="margin:2%; face">Mini Implantes para Ortodoncia</h4>
                    <p class="text-info text-left face" style="margin:2%;">
                        Los mini implantes o mini tornillos de anclaje temporal, han revolucionado los tratamientos de
                        ortodoncia, ya que con ellos nos podemos anclar sin tocar las piezas posteriores para poder
                        mover los dientes anteriores. También son conocidos como micro tornillos o bien como mecanismos
                        de anclaje temporal, mismos que son removidos una vez que termina su función.
                    </p>

                </div>
                <div class="col-6 mt-5 rounded face">
                    <img class="rounded w-70 img-responsive" 
                    style="margin-bottom:2%; margin-left:8%;  border-radius: 40px 10px;"
                        src="https://clinicabalut.com/wp-content/uploads/2019/04/mini_implante_1.jpg" alt="promocion">
                </div>


                <div class="col-6 mt-5 text-secondary face">
                    <p style="font-family: 'Oxygen', sans-serif; margin:2%;" class="text-info text-left" >
                        Los micro implantes son muy fáciles de colocar, no se necesita usar agujas para anestesiar.
                        Utilizamos un gel anestésico muy potente, no es necesario hacer ningún tipo de incisión o corte,
                        se atornillan directamente al hueso a través de la encía y la colocación tarda de 3 a 4 minutos.
                        </ol>
                        <p class="text-info text-left face" style="margin:2%;">Retirarlos tampoco es complicado, basta con colocar un poco del
                            gel
                            anestésico y con un pequeño desarmador se remueven sin dolor ni molestia.</p>
                        <p class="text-info text-left face" style="margin:2%;">Los mini implantes ayudan, en algunos casos, a reducir el tiempo
                            de
                            tratamiento, obteniendo con su uso mejores resultados, incluso en ocasiones nos ayudan a
                            evitar un tratamiento combinado de ortodoncia y cirugía, resolviéndolo exclusivamente con
                            Ortodoncia.
                ...
                <div class="col-6 mt-5 rounded face">
                    <img class="rounded w-70 img-responsive" style="margin-bottom:2%; margin-left:8%;  border-radius: 40px 10px;"
                        src="https://clinicabalut.com/wp-content/uploads/2019/04/mini_implante_2.jpg" alt="promocion">
                </div>
