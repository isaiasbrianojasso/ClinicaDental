        ...
        <div class="container bg-white">
            <div class="row">
                ...
                border-radius: 40px 10px;">      
                    <h1 class="text-white text-center mt-3 ml-5 mr-5">¿Quienes Somos?</h1>
                </div>
                <div class="col-md-6 mt-5 text-secondary">
                    <div class="col-lg-12 my-5 text-lg-left text-center">
                        <div class="row">
                            <div class="col-md-12">
                                <p class="card-body text-center" style="margin-left:10%; margin-top:2%;">En Odontología Médica Coral trabajamos en equipo, siendo
                                    profesionales con un objetivo primordial; trabajar con ética y responsabilidad,
                                    proveemos servicios odontológicos integrales de la más alta calidad con el mejor
                                    equipo, materiales de calidad e instalaciones de vanguardia, siempre buscando la
                                    prevención y resolución de problemas de salud y estética en un ambiente de
                                    especializado para cada paciente, basados en la ética, en los conocimientos y la
                                    satisfacción de cada paciente. <br>
                    
                                    <p class="card-body text-center" style="margin-left:10%;">Siempre comprometidos en ofrecer a los pacientes lo mejor en servicios dentales, el
                                    conocimiento actualizado para tratamientos de éxito, y comodidad dentro de las
                                    instalaciones. <br>
                                    ¡Sonríe más, sonríe Mejor.
                                    <br>
                                 <p class="card-body text-center" style="margin-left:10%; margin-bottom:12%;"> Nuestro Éxito está en la satisfacción detrás de cada
                                    sonrisa!</p>
                            </div>
                        </div>
                    </div>
